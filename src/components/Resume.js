...
const markdownStyles = compose(
  relative,
  { maxWidth: '45rem' },
  { padding: '3.125rem 1rem 1rem' },
  { margin: '0 auto' },
  $('& h1', compose(sticky, { top: '0.75rem' }, zIndex2)),
  $('& #ello', padLeftStyle),
  $('& #mode-set', padLeftStyle),
  $('& #factory-labs', padLeftStyle),
  $('& #the-firm-graphics', padLeftStyle),
  $('& #ello + h4', padLeftStyle),
  $('& #mode-set + h4', padLeftStyle),
  $('& #factory-labs + h4', padLeftStyle),
  $('& #the-firm-graphics + h4', padLeftStyle),
  ...
  $('& #the-firm-graphics', before(compose(
    iconPositionStyle,
